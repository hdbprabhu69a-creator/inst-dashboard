  ...
  return (
    <thead>
      <tr className="bg-zinc-950">
        ...
        {show("1W") && (
          <>
            <th className="border border-zinc-800 px-0.5 py-1 text-center">
              1W H
            </th>
            <th className="border border-zinc-800 px-0.5 py-1 text-center">
              1W HD
        ...
        {swingFilter !== "PIVOT" &&
          swingFilter !== "VOLDEL" && (
            <>
              <th className="border border-green-700 bg-green-950 px-0.5 py-1 text-center">
                23.6
              </th>
        ...
        {swingFilter === "PIVOT" ? (
          <>
            ...
            <th className="border border-cyan-700 text-center font-bold">
              DP
            </th>
            ...
            <th className="border-l-2 border-l-zinc-600 border border-red-900 text-center">
              WS3
            </th>
          ...
          <>
            <th className="border border-zinc-700 text-center">
              Type
            </th>
