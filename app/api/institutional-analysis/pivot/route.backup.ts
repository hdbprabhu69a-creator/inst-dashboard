...
import { getMarketStructure, updateEngine } from "@/institutional-analysis/repository/marketStructureRepository";
...
export async function GET(){
  ...
  try{
    ...
    for(const stock of universe){
      ...
      if(process.env.ENGINE_WRITE_MODE==="development"){
